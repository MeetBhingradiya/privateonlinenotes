...
export default function ExplorePage() {
    ...
    const filteredFiles = files.filter(file =>
        ...
        (file.owner && file.owner.name.toLowerCase().includes(searchQuery.toLowerCase()))
    )
                                ...
                                <div className="flex bg-white/50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-700 p-1">
                                    {[
                                        ...
                                        <button
                                            ...
                                            className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${sortBy === key
                            ...
                            {filteredFiles.map((file) => (
                                ...
                                >
                                    <div className="p-6">
                                        {/* File Header */}
                                        <div className="flex items-center space-x-3 mb-4">
                                            <div className={`w-10 h-10 rounded-xl flex items-center justify-center ${file.type === 'folder'
                                        ...
                                        <div className="space-y-3 mb-6">
                                            <div className="flex items-center justify-between text-sm text-gray-600 dark:text-gray-400">
                                                <div className="flex items-center space-x-1">
                                                    ...
                                                    <span className="truncate">{file.owner ? file.owner.name : 'Anonymous'}</span>
                                                </div>
                                                <div className="flex items-center space-x-1">
                                        ...
                                        {/* Action Button */}
                                        <Link href={`/share/${file.slug || file.shareCode}`}>

    ...
    return (
        <div className="flex h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 dark:from-gray-900 dark:via-blue-900 dark:to-purple-900 overflow-hidden">
            ...
            <div className={`glass-sidebar ${sidebarCollapsed ? 'w-20' : 'w-72'} transition-all duration-300 ${sidebarCollapsed ? 'px-3 py-4' : 'px-5 py-4'} bg-white/10 dark:bg-white/5 border-r border-white/20 dark:border-white/10 backdrop-blur-xl flex flex-col h-full`}>
                ...
                {!sidebarCollapsed && (
                    <div className={`mb-6 p-4 glass-card border-white/20 dark:border-white/10 rounded-xl transition-all duration-300 ${user.plan === 'enterprise'
                        ...
                        <div className="flex items-center space-x-3">
                            <div className={`h-8 w-8 rounded-lg flex items-center justify-center transition-all duration-300 ${user.plan === 'enterprise'
                                ...
                                <Icon
                                    icon={user.plan === 'enterprise' ? "material-symbols:workspace-premium" :
                                        user.plan === 'premium' ? "material-symbols:star" :
                                            "material-symbols:person"}
                                    className={`h-4 w-4 text-white ${user.plan === 'enterprise' ? 'animate-spin' : ''}`}
                                />
                            </div>
                            <div>
                                <p className="text-sm text-foreground/90 font-medium">{user.name}</p>
                                <div className="text-xs text-foreground/60 flex items-center space-x-1">
                                    <span className={`capitalize font-semibold ${user.plan === 'enterprise'
                ...
                {sidebarCollapsed && (
                    <div className="flex flex-col space-y-2 items-center mb-6">
                        ...
                        <div className={`w-3 h-3 rounded-full shadow-lg transition-all duration-300 ${user.plan === 'enterprise'
                        ...
                        {/* Premium glow effect */}
                        {user.plan === 'premium' && (
                            <div className="w-1 h-1 rounded-full bg-green-300 animate-pulse opacity-60" title="Premium Features Active"></div>
                        )}
                        {/* Enterprise sparkle effect */}
                        {user.plan === 'enterprise' && (
